 ...
 * the License.
 */
package com.finarx.gwt.dnd.demo.client.example.window;
...
final class ResizeDragController extends AbstractDragController {
  ...
  private HashMap<Widget, WindowPanel.DirectionConstant> directionMap = new HashMap<Widget, WindowPanel.DirectionConstant>();
